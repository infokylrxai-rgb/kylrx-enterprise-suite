...
app.use(helmet({
    ...
    contentSecurityPolicy: {
        directives: {
            ...
            "connect-src":      ["'self'", "https://www.gstatic.com", "https://identitytoolkit.googleapis.com", "https://securetoken.googleapis.com", "https://firestore.googleapis.com", "wss://*.firebaseio.com", "https://*.firebaseapp.com", "http://localhost:3000", "http://127.0.0.1:3000", "http://localhost:5501", "http://127.0.0.1:5501", "http://127.0.0.1:5500", "https://unpkg.com", "https://cdn.jsdelivr.net"],
            "font-src":         ["'self'", "https://fonts.gstatic.com", "data:"],
            "frame-src":        ["'self'", "https://planning-with-ai-c026b.firebaseapp.com", "https://apis.google.com"],
            "object-src":       ["'none'"],
